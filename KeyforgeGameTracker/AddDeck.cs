...
namespace KeyforgeGameTracker
{
    public static class AddDeck
    {
            ...
            string player, string deck, TraceWriter log)
        {
            ...
            // Request
            //https://www.keyforgegame.com/api/decks/?page=1&page_size=10&search=xinia,+quarter+composer&power_level=0,11&chains=0,24&ordering=-date
            ...
            return new PlayerDeck(player, deck);
        }
    }
}
